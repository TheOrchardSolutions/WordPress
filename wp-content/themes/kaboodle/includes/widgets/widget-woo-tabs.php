...
if (!function_exists( 'woo_widget_tabs_popular')) {
	...
	?>
	<li>
	<?php if(get_option('woo_post_calendar') == "true") { ?><div class="ico-cal alignleft"><div class="ico-day"><?php the_time('d'); ?></div><div class="ico-month"><?php the_time('M'); ?></div></div><?php } elseif ($size <> 0) { woo_image( 'height='.$size.'&width='.$size.'&class=thumbnail&single=true' ); } ?>
