	...
	<body id="index" class="index">
		<div class="container">
			...
			<form action="agreement.pl" method="post" accept-charset="utf-8" name="pay" id="pay">
				...
				<div class="span-14">
					<fieldset>
						<legend><span class="order_num">2</span> Quantities</legend>
						...
						<table width="400">
							...
							<tr>
								<td valign="top">
									<a style="color:black; text-decoration: none;" target=_blank href="https://macconsultinggroup.com/services/support-packages/watchman-monitoring"><strong>Monitored Computers</strong></a><br>
							...
							<tr>
								<td valign="top">
								<img src="https://macconsultinggroup.com/agreement/plus-icon.gif"/>	<u id="iwantadvanced"><strong>Additional Support Options<strong></u><br>
								</td>
							</tr>
							<tr id="advanced_ops_one" class="adv_close_section">
								<td valign="top">
							...
							<tr id="advanced_ops_two" class="adv_close_section">
								<td valign="top">
										<a style="color:black; text-decoration: none;" target=_blank href="https://macconsultinggroup.com/services/support-packages/premier-support"><strong>Premier Support Users</strong></a><br>
