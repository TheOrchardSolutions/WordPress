...
class Gravityforms_Autocomplete {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Gravityforms_Autocomplete_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_filter( 'gform_add_field_buttons', $plugin_admin, 'add_autocomplete_field' );
		$this->loader->add_filter( 'gform_field_type_title', $plugin_admin, 'add_autocomplete_field_title' );
		$this->loader->add_filter( 'gform_field_input', $plugin_admin, 'add_autocomplete_custom_fields', 10, 5 );
