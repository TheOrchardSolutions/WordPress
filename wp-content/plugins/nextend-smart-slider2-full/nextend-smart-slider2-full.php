<?php
/*
Plugin Name: Nextend Smart Slider 2 Full
...
if(function_exists('nextend_smart_slider2_activation')){
    echo "Please disable the free version of Smart Slider 2 before activation!";
    exit;
}else{
        ...
        if(defined('NEXTENDLIBRARY')){
            ...
            if(!function_exists('nextend_plugin_api_call')){
                ...
                $updateChecker = new PluginUpdateChecker(
                    'http://www.nextendweb.com/update2/wordpress/index.php?action=get_metadata&slug=nextend-smart-slider2-full&api-key='.get_option('nextend_smart_slider2_license', ''),
                    __FILE__
                );
            }else{
