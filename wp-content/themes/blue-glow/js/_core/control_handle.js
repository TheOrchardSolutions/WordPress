...
///////////////////////////////
	...
	qcodo.registerControlHandle = function(mixControl, strCursor) {
		...
		objWrapper.updateHandle = function(blnUpdateParent, strCursor) {
			...
			if (qcodo.isBrowser(qcodo.IE)){ // XSILVA CLEVERAPPZ - Firefox/Safari was leaving the handle over the page as well which was blocking other items from being accessed.
