...
if ( ! function_exists( 'woo_shortcode_styledtext' ) ) {
	function woo_shortcode_styledtext ( $atts, $content = null ) {
		...
		return apply_filters( 'woo_shortcode_styledtext', $output, $atts );
		
	} // End woo_shortcode_styledtext()
}

add_shortcode( 'styled_text', 'woo_shortcode_styledtext' );
