...
$options[] = array( "name" => "Animation Speed",
                    "desc" => "The time in <strong>miliseconds</strong> the animation between frames will take.",
...
$options[] = array(    "name" => "Auto Slide Interval",
                    "desc" => "The time in <strong>milliseconds</strong> each portfolio item pauses for, before sliding to the next.",
...
$options[] = array( "name" => "Calendar As Thumb",
					"desc" => "This will enable a calendar icon instead a post image thumb",
