...
my $pubRecip = 'allen@macconsultinggroup.com';
my $sender = 'allen@macconsultinggroup.com';
my $subject = "Agreement Signup for " . ($vars{'docid'} or $vars{'company'} or "$vars{'firstname'} $vars{'lastname'}" or "Unknown");
...
<html lang="en">
	<head>
		<title>
			Mac Consulting Group Service Agreement Signup Form
		</title><!-- Framework CSS -->
