...
* Belorussian (be_BY) - thanks [Slava Mikheev](http://mikheev.biz/)
* Ukrainian (uk_UA) - thanks [Kostjushko Konstantin](http://farmline.com.ua/)
...
= 1.9 =
* Make Invisible Defender compabible with Login With Ajax plugin

= 1.8.3 =
* Added Ukrainian translation (thanks Kostjushko Konstantin)

= 1.8.2 =
* Added Belorussian translation (thanks Slava Mikheev);
