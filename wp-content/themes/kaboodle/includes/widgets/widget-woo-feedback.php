            ...
            <div class="feedback">
				...
				<?php foreach($feedback as $post) : setup_postdata($post); ?>
	            	...
	            	<div class="quote">
	                    ...
	                    <?php if ( $author ) { ?><cite><?php echo $author; ?></cite><?php if ( $url ) { ?><a href="<?php echo $url; ?>"><?php echo $url; ?></a> &rarr;<?php }} // End IF Statement ?>
	                </div>
	            ...
	            <?php endforeach; ?>
					...
					<?php
		        		if ( count( $feedback ) > 1 ) {
		        			echo '<a href="#" class="btn-prev">' . __( 'Previous', 'woothemes' ) . '</a>' . "\n";
