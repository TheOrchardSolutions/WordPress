...
function classic_default_settings( $settings ) {
	...
	$settings->classic_ipad_webapp_retina_loading_img_location = '';
	$settings->classic_ipad_webapp_landscape_loading_img_location = '';
	$settings->classic_ipad_webapp_retina_landscape_loading_img_location = '';
	...
	$menu = array(
		...
		__( "iOS Web-App Mode", "wptouch-pro" ) => array ( 'web-app-mode', 
			array(
				...
				array( 'text', 'classic_ipad_webapp_retina_loading_img_location', __( 'URL to Retina iPad Portrait startup screen (1536x2008) (.png) (iOS 5+)', "wptouch-pro" ) ),
				array( 'text', 'classic_ipad_webapp_retina_landscape_loading_img_location', __( 'URL to Retina iPad Landscape startup screen (2048x1496) (.png) (iOS 5+)', "wptouch-pro" ) ),
